...
let cssquestions = require('./questions/css');
let javascriptquestions = require('./questions/javascript');
let generalquestions = require('./questions/general');

let randomquestions = require('./questions/random');
...
const languageString = {
    ...
    'en-US': {
        'translation': {
            'QUESTIONS': randomquestions['QUESTIONS_EN_US'],
            'GAME_NAME': 'Free Code Camp Development Quiz', // Be sure to change this for your skill.
        },
    },
    'en-GB': {
        'translation': {
            'QUESTIONS': randomquestions['QUESTIONS_EN_GB'],
            'GAME_NAME': 'Free Code Camp Development Quiz', // Be sure to change this for your skill.
        },
    },
  ...
  const chosenSubjectString = (choiceArr[chosenSubject - 1]) !== undefined ? choiceArr[chosenSubject -1] : 'Random topics';
    ...
    //insert choice into welcome string
      ...
      //this.emit(':tell', chosenSubject)
         ...
         languageString['en-GB']['translation']['QUESTIONS'] = javascriptquestions['QUESTIONS_EN_GB'];
         ...
         languageString['en-GB']['translation']['QUESTIONS'] = cssquestions['QUESTIONS_EN_GB'];
         ...
         languageString['en-GB']['translation']['QUESTIONS'] = generalquestions['QUESTIONS_EN_GB'];
         ...
         languageString['en-GB']['translation']['QUESTIONS'] = randomquestions['QUESTIONS_EN_GB'];
...
let setupStateHandlers = Alexa.CreateStateHandler(GAME_STATES.SETUP, {
    'SetUp': function () {
